...
const Picture = ({onPress,nome, foto, descricao, data, localizacao, estado, buttonLeft, buttonRight, numero, email }) => {
  ...
  <View>
        ...
        <Text className="text-sm italic mt-4 truncate">Localização do {estado}: {localizacao}</Text>
        <Text className="text-sm italic mt-4 truncate">{data}</Text>
          <CustomButton handlePress={onPress} title={buttonLeft} containerStyles="w-48 mt-4"/>
          </View>
