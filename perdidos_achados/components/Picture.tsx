  ...
  <View>
        <View className="flex flex-col space-y-3 justify-center mb-8">
          ...
          style={[styles.tinyLogo]}
            source={{
              uri: 'https://i5.walmartimages.com/asr/85a53698-2b3c-48b1-a238-52541ddb3ccd_1.4e374eb556fc18086b0b6bc1b08f94ee.jpeg?odnHeight=717&odnWidth=717&odnBg=FFFFFF',
            }}
          />
